...
public class Waypoint_Indicator_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        serializedObject.FindProperty("doEvents").boolValue = EditorGUILayout.Foldout(targetScript.doEvents, "Setup Events", true, EditorStyles.foldout);
        if (targetScript.doEvents)
        {
            EditorGUI.indentLevel++;
            SerializedProperty onScreenEventProperty = serializedObject.FindProperty("onScreenEvent");
            EditorGUILayout.PropertyField(onScreenEventProperty, new GUIContent("On Screen Event"));
        
            SerializedProperty onWaypointReachedEventProperty = serializedObject.FindProperty("onWaypointReachedEvent");
            EditorGUILayout.PropertyField(onWaypointReachedEventProperty, new GUIContent("On Waypoint Reached Event"));
            EditorGUI.indentLevel--;
        }
        ...
        if (targetScript.toggleSetupOptions)
        {
            ...
            serializedObject.FindProperty("hidesWhenReachedMinDist").boolValue = EditorGUILayout.Toggle("Hides Waypoint once reached min distance", targetScript.hidesWhenReachedMinDist);
