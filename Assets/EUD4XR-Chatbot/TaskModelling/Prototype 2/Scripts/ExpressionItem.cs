    ...
    public class ExpressionItem : MonoBehaviour
    {
        ...
        private void HandleAutomationInfo(Automation automation)
        {
            ...
            if (buttonRef != openAutomation)
            {
                ...
                popUp.OnPrefabCreated((string)uiExprRef.GetAutomationInfo(automation), buttonRef);
            }
        ...
        private void SetItemName([NotNull] Automation automation) => contentRef.text = automation.Name[(automation.Name.IndexOf(".") + 1)..].Replace('_', ' ');
